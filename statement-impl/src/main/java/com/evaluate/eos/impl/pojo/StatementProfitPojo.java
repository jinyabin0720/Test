...
@TableName("xip_ba_data_analyze_profits")
public class StatementProfitPojo {
    ...
    @TableId(type = IdType.UUID ,value = "ANALYZE_PROFITS_ID")
    private String analyzeProfitsId;
    ...
    public String getAnalyzeProfitsId() {
        return analyzeProfitsId;
    }

    public void setAnalyzeProfitsId(String analyzeProfitsId) {
        this.analyzeProfitsId = analyzeProfitsId;
    }
    ...
    public String toString() {
        return "StatementProfitPojo{" +
                "analyzeProfitsId='" + analyzeProfitsId + '\'' +
